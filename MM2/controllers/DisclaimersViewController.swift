...
class DisclaimersViewController: UIViewController {
    ...
    var attributionData = "Data provided for free by IEX. View IEX’s Terms of Use.(https://iextrading.com/api-exhibit-a//nwith the migration to iexCloud please note the following/nhttps://iexcloud.io>data provided by IEX Cloud</a>"
